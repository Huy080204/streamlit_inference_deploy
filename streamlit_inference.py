...
class Inference:
    ...
    def inference(self):
        ...
        # Khởi tạo vòng lặp asyncio nếu chưa có
        ...
        if self.source == "webcam":
            ...
            webrtc_streamer(
                ...
                video_transformer_factory=lambda: YOLOTransformer(
                    ...
                    enable_trk=(self.enable_trk == "Yes")
                ),
            ...
            if self.vid_file_name:
                ...
                self.st.success("Processing uploaded video...")

                while cap.isOpened():
                    success, frame = cap.read()
                    if not success:
                        self.st.warning("⚠️ End of video or failed to read frame.")
                        break
